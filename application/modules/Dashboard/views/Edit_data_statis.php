	...
	<div id="page-wrapper">
        <div id="page-inner" style="margin-top:8%;"> 
            ...
            <div class="page-header">
  				<h1>Edit<small> Data Statis</small></h1>
			</div>
           <div class="panel panel-default">
                    <div class="panel-heading"><a href="<?php echo base_url('index.php/Dashboard/DataStatis');?>" class="link">&laquo; Kembali</a></div>
                    <div class="panel-body">
                        <form action="<?php echo base_url('index.php/Dashboard/DataStatis/SaveUpdate'); ?>" method="post">
                        <input type="hidden" name="id_konten" value="<?php echo $id_content; ?>">
                        <div class="row">
                            <div class="col-md-9">
